...
- (void)viewDidLoad
{
    ...
    self.checkins = [[CheckInManager alloc] getCheckIns];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CheckIn *_checkin = [self.checkins objectAtIndex:indexPath.row];

    [cell setTitle:@"Test" andSubTitle:_checkin.description];
    // Configure the cell...
